...
Predictor <- colnames(Sensors)[-3]

# Select the corresponding columns
Data1 <- Sensors[, c("Room", "Humidity")]
Data2 <- Sensors[, c("Room", "Temperature")]
Data3 <- Sensors[, c("Room", "PPM")]
# Split data into training and test sets Humidity - Temperature - PPM
set.seed(123)
trainIndex1 <- createDataPartition(Data1$Room, p = 0.8, list = FALSE)
trainData1 <- Data1[trainIndex1, ]
testData1 <- Data1[-trainIndex1, ]
testData2 <- Data2[-trainIndex1,]
```
